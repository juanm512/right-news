...
export default function Nav({ children }: { children: React.ReactNode }) {
  ...
  return (
    <>
      ...
      <motion.button
        className="group fixed z-10 bottom-4 right-4 px-2 py-2 flex flex-row items-center justify-center rounded-full bg-neutral-300 dark:text-white dark:bg-neutral-800 shadow-md hover:bg-neutral-400 dark:hover:bg-neutral-700 focus:outline-none focus:ring-1 focus:ring-neutral-500"
        onClick={() => {
      ...
      >
        <svg
          ...
          className="w-6 h-6 stroke-current inline-block"
          width={24}
          height={24}
          viewBox="0 0 24 24"
          strokeWidth={2}
